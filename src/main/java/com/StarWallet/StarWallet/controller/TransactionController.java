...
public class TransactionController {
    ...
    @PostMapping
    public Transaction createTransaction(@RequestBody CreateNewTransaction createNewTransaction){
        return transactionService.createTransaction(createNewTransaction);
    }
}
