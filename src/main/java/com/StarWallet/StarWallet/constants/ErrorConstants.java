package com.StarWallet.StarWallet.constants;

public class ErrorConstants {

    public static final String USER_TYPE_NOT_FOUND_ERROR = "Invalid user type.";
    public static final String USER_NOT_FOUND_ERROR = "User not found.";
    public static final String INSUFFICIENT_WALLET_BALANCE_ERROR = "Insufficient wallet balance to make transaction. Please recharge your wallet and try again.";
